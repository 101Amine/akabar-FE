        ...
        <div style={{display: 'flex', gap: '50px'}}>
          <div style={{width: '50%'}}>
            ...
            <FormControl style={{ flex: 0.35, width: '100%' }} margin="normal">
              {selectedValue && <Typography variant="subtitle2" marginBottom="0.5em" marginLeft="0.5em" opacity="0.6">
                Support (PAPIER)
              </Typography>
              }
              {!selectedValue &&  <InputLabel shrink={false}>Support (PAPIER)</InputLabel> }
              <Select
                displayEmpty
            ...
            <Box border="1px solid #7679da" borderRadius="4px" padding="1em" marginBottom="1em" marginTop="2em">
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <RadioGroup
                ...
                <Grid container spacing={1}>
                  <Grid item>
                    <FormControlLabel value="recto" control={<Radio />} label="Recto" />
                  </Grid>
                  <Grid item>
                    <FormControlLabel value="verso" control={<Radio />} label="Verso" />
                  </Grid>
                </Grid>
              </RadioGroup>
            </div>
          ...
          <Box border="1px solid #7679da" borderRadius="4px" padding="1em" marginBottom="1em" marginTop="2em">
            ...
            <Typography ariant="h3" style={{ fontWeight: 600, fontSize: 18, marginBottom: 10, marginTop: 10 }}>Poses d'etiquette :</Typography>
              <RadioGroup
                  ...
                  onChange={(event) => handleRadioButtonChange('labelPose', event.target.value)}
              >
              <FormControlLabel value="true" control={<Radio />} label="Auto" />
              <FormControlLabel value="false" control={<Radio />} label="Manuelle" />
            </RadioGroup>
            ...
            <div style={{display: 'flex', gap: 100, marginTop: 20}}>
              <div>
                ...
                <RadioGroup
                  ...
                  onChange={(event) => handleRadioButtonChange('repiquage', event.target.value)}
                >
                  <Grid container spacing={1}>
                    <Grid item>
                      <FormControlLabel value="oui" control={<Radio />} label="Oui" />
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onChange={(event) => handleRadioButtonChange('vernis', event.target.value)}
                >
                  <Grid container spacing={1}>
                    <Grid item>
                      <FormControlLabel value="oui" control={<Radio />} label="Oui" />
              ...
              <div>
                ...
                <RadioGroup row
                            ...
                            onChange={(event) => handleRadioButtonChange('dorure', event.target.value)}
                >
                  <Grid container spacing={1}>
                    <Grid item>
                      <FormControlLabel value="oui" control={<Radio />} label="Oui" />
              ...
              <div>
                ...
                <RadioGroup row
                            ...
                            onChange={(event) => handleRadioButtonChange('plastification', event.target.value)}
                >
                  <Grid container spacing={1}>
                    <Grid item>
                      <FormControlLabel value="oui" control={<Radio />} label="Oui" />
            ...
            <div>
              ...
              <FormControl margin="normal" fullWidth>
                {selectedMandarin && <Typography variant="subtitle2" marginBottom="0.5em" marginLeft="0.5em" opacity="0.6">
                  Mandarin
                </Typography>
                }
                {!selectedMandarin &&
